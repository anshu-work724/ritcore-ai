    ...
    links: [
      {
        ...
        href: "../src/assets/documents/privacy-policy.pdf",
        external: true,
      },
      {
        label: "Terms and Conditions",
        href: "../src/assets/documents/terms-and-conditions.pdf",
        external: true,
      },
    ],
  },
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                id="footer-email"
                aria-label="Email"
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/8 bg-white/5 text-white/50 transition-all duration-200 hover:border-cyan-500/40 hover:bg-cyan-500/20 hover:text-cyan-400"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
